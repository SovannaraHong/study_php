     <?php
        ...
        $courses = ["BCA(Bachelor of ComputerApplication)", "B.Com(Bachelor of Commerce)", "B.Sc(Bachelor of Science)", "BA(Bachelor Of Art)", "MCA(Master Of Computer Application)", "M.Com(Mater of Commerce)"];
         ...
         <div id="wrapper"
             ...
             <div id="right"
                 ...
                 <div id="title"
                     ...
                     <span class="text-[28px]  font-normal font-press-start-2p-regular"><span>𑣲</span>Student <span class="text-[#ffc5ef]">Registration</span> Form <span>‧₊˚❀༉‧₊˚.</span></span>
                 </div>
                 ...
                 <div id="content">
                     <form class="w-full" action="" method="post" enctype="multipart/form-data">
                         <fieldset class=" bg-[#fcfafc] border-4 border-[#FFDBFD] rounded-2xl px-5 pb-5">
                             ...
                             <!-- <legend class="text-lg font-bold ml-[100px] px-5 py-2">
                             ...
                             <div class="flex gap-2 items-center mb-4 field">
                                 ...
                                 <div class="flex flex-wrap gap-4 font-normal text-[20px]">
                                     <?php foreach ($hubbies as $hobby) : ?>
                                         <label class="font-semibold uppercase font-space text-[15px]"><input name="hub" type="checkbox"> <?= $hobby ?></label>
                                     <?php endforeach; ?>
                             ...
                             <div class="flex gap-2 items-center mb-4 field">
                                 ...
                                 <?php foreach ($qualifications as $qual) : ?>
                                     <label class="font-semibold uppercase font-space text-[15px]"><input type="radio" class="bg-[#FFDBFD]" name="qualification"> <?= $qual ?></label>
                                 <?php endforeach; ?>
     ...
     <?php
        if (isset($_POST['btn-submit'])) {
            ...
            $hubbies = $_POST['hub'];
            // Picture is a file input so use $_FILES
            ...
            // Hubbies/hobbies may be multiple values
            if (is_array($hubbies)) {
                echo "hubbies = " . implode(", ", $hubbies) . "<br>";
            } else {
                echo "hubbies = " . $hubbies . "<br>";
            }
            // Picture is an uploaded file, print only the file name for safety
